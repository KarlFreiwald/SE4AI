...
def load_data_from_pickle():
    ...
    train_data_path = '../SE4AI_data/x_train.pickle'
    validation_data_path = '../SE4AI_data/x_val.pickle'
    test_data_path = '../SE4AI_data/x_test.pickle'

    train_label_path = '../SE4AI_data/y_train.pickle'
    validation_label_path = '../SE4AI_data/y_val.pickle'
    test_label_path = '../SE4AI_data/y_test.pickle'
